...
Related exercises: #book-link(<exercise-ii-6-1>)[II.6.1] for the general product problem, and #book-link(<exercise-ii-6-5>)[II.6.5] for the remaining quadric dimensions. DV-15–DV-16 supply the indicated surface cases.
