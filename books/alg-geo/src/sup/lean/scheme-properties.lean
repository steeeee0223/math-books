...
all hypotheses of the cited theorems. XP-3 is covered by ii-2-exe.lean.
...
/-- XP-1a, the complete assertion for an arbitrary scheme. -/
...
/-- XP-7 includes quasi-compactness, not just local finite type. -/
...
/-- XP-E6: in a square-zero ideal a prime contains every element. -/
...
/-- XP-E7's actual strictly increasing sequence of ideals in the Boolean product. -/
